package parking.car.project.commentservice;
...
public class CommentService {
	...
	/*
	 * @Transactional(readOnly = true) public List<Comment> findAllComments(int
	 * parking_code) { return commentRepository.findByParkingCode(parking_code); }
	 */
