        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-right">
                ...
                <ul class="nav nav-tabs d-inline-flex">
                    <li class="nav-item">
                        <a class="nav-link active btn-custom" href="#">공지사항</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn-custom" href="./NoticeSelectEvent">이벤트</a>
                    </li>
                </ul>
            </div>
        </div>
...
<section id="notices">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form action="./NoticeSelect" method="get" class="form-inline my-2 my-lg-0">
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach var="notice" items="${noticePage.content}">
                                <tr class="text-center">
                                    ...
                                    <td><a href="./NoticeSelectDetail?notice_code=${notice.notice_code}">${notice.notice_title}</a></td>
