...
<h1> 부서 정보 수정 </h1>
 ...
 <div class="card-body">
 <form action="./DeptUpdateView.so" method="post" id="sign_dept">
 <fieldset>
...
<button type="submit" class="btn btn-secondary"> 등록 </button>
 ...
 <div class="row">
 <div class="col-md-4">
 <a href="./DeptSelect.so" class="btn btn-primary btn-block"> 부서 목록 </a>
 </div>
 <div class="col-md-4">
 <a href="./DeptInsertView.so" class="btn btn-success btn-block"> 부서 입력 </a>
 </div>
 <div class="col-md-4">
 <a href="./DeptDeleteView.so?deptno=${param.deptno}" class="btn btn-danger btn-block"> 
부서 삭제 
</a>
 </div>
 </div>
