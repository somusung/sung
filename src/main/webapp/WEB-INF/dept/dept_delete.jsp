<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
 ...
 <div class="card-body">
 <form action="./DeptDelete.so" method="post" id="sign_dept">
 <fieldset>
...
<button type="submit" class="btn btn-secondary"> 삭제 </button>
 ...
 <div class="row">
 <div class="col-md-4">
 <a href="./DeptSelect.so" class="btn btn-primary btn-block"> 
부서 목록 
</a>
 </div>
 <div class="col-md-4">
 <a href="./DeptInsertView.so" class="btn btn-success btn-block"> 
부서 입력
</a>
 </div>    
<div class="col-md-4">
 <a href="./DeptUpdateView.so?deptno=${param.deptno}" class="btn btn-warning btn-block">
부서 수정 
</a>
 </div>
 </div>
